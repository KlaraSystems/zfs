...
vdev_prop_init(void)
{
	...
	zprop_register_number(VDEV_PROP_BYTES_TRIM, "trim_bytes", 0,
	    ...
	    sfeatures);
	zprop_register_number(VDEV_PROP_ANYRAID_CAP_REGIONS,
	    "anyraid_region_capacity", 0, PROP_READONLY, ZFS_TYPE_VDEV,
	    "<regions>", "REGIONCAP", B_FALSE, sfeatures);
	zprop_register_number(VDEV_PROP_ANYRAID_NUM_REGIONS,
	    "anyraid_region_count", 0, PROP_READONLY, ZFS_TYPE_VDEV,
	    "<regions>", "NUMREGIONS", B_FALSE, sfeatures);
	zprop_register_number(VDEV_PROP_ANYRAID_REGION_SIZE,
	    "anyraid_region_size", 0, PROP_READONLY, ZFS_TYPE_VDEV,
	    "<bytes>", "REGIONSIZE", B_FALSE, sfeatures);
