...
spa_load_impl(spa_t *spa, spa_import_type_t type, const char **ereport)
{
	 ...
	 */
	(void) spa_import_progress_set_notes(spa_guid(spa),
	    (char *)"Loading indirect vdev metadata");
	 ...
	 */
	(void) spa_import_progress_set_notes(spa_guid(spa),
	    (char *)"Loading special MOS directories");
	 ...
	 */
	(void) spa_import_progress_set_notes(spa_guid(spa),
	    (char *)"Loading vdev metadata");
	error = spa_ld_load_vdev_metadata(spa);
	if (error != 0)
		return (error);

	(void) spa_import_progress_set_notes(spa_guid(spa),
	    (char *)"Loading dedup tables");
	 ...
	 */
	(void) spa_import_progress_set_notes(spa_guid(spa),
	    (char *)"Calculating deflated space");
	...
	if (spa_writeable(spa) && (spa->spa_load_state == SPA_LOAD_RECOVER ||
		...
		(void) spa_import_progress_set_notes(spa_guid(spa),
		    (char *)"Restarting device removals");
		 ...
		 */
		(void) spa_import_progress_set_notes(spa_guid(spa),
		    (char *)"Cleaning up inconsistent objsets");
		 ...
		 */
		(void) spa_import_progress_set_notes(spa_guid(spa),
		    (char *)"Cleaning up temporary uerrefs");
		dsl_pool_clean_tmp_userrefs(spa->spa_dsl_pool);

		spa_config_enter(spa, SCL_CONFIG, FTAG, RW_READER);
		(void) spa_import_progress_set_notes(spa_guid(spa),
		    (char *)"Restarting Initialize");
		vdev_initialize_restart(spa->spa_root_vdev);
		(void) spa_import_progress_set_notes(spa_guid(spa),
		    (char *)"Restarting TRIM");
		vdev_trim_restart(spa->spa_root_vdev);
		vdev_autotrim_restart(spa);
		spa_config_exit(spa, SCL_CONFIG, FTAG);
		(void) spa_import_progress_set_notes(spa_guid(spa),
		    (char *)"Finished importing");
	}
