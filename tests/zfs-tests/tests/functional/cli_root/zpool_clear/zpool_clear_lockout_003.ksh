...
# STRATEGY:
# 1. Create a pool.
# 2. Run 'zpool clear -R' on the pool
# 3. Try to create a file on the pool
# 3. Export pool
#
...
# 3. Try to create a file on the pool
log_mustnot touch /$TESTPOOL1/empty.bin

# 4. Export pool
log_must zpool export $TESTPOOL1

log_pass "Creating file on lockout pool fails as expected."
